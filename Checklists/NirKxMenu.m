...
- (UIView *) mkContentView
{
    ...
    for (KxMenuItem *menuItem in _menuItems) {
        ...
        if (menuItem.title.length) {
            ...
            if ([menuItem isEqual:_menuItems[0]])
            {
                titleLabel.textColor = [UIColor colorWithRed:self.kxMenuViewOptions.firsttextColor.R green:self.kxMenuViewOptions.firsttextColor.G blue:self.kxMenuViewOptions.firsttextColor.B alpha:self.kxMenuViewOptions.firsttextColor.A];
            }
            else
            {
                titleLabel.textColor = [UIColor colorWithRed:self.kxMenuViewOptions.textColor.R green:self.kxMenuViewOptions.textColor.G blue:self.kxMenuViewOptions.textColor.B alpha:self.kxMenuViewOptions.textColor.A];
            }
             ...
             inContext:(CGContextRef) context
{
    ...
    CGFloat R0 = self.kxMenuViewOptions.menuBackgroundColor.R, G0 = self.kxMenuViewOptions.menuBackgroundColor.G, B0 = self.kxMenuViewOptions.menuBackgroundColor.B, A0 = self.kxMenuViewOptions.menuBackgroundColor.A;
    
    CGFloat R1 = R0, G1 = G0, B1 = B0, A1 = A0;
